...
#define mot_in4 5 //пин правого мотора
#define mot_enb 4 //пин ШИМа правого мотора
#define ir_1 A1 //пин 1 ИК-датчика
#define ir_2 A2 //пин 2 ИК-датчика
#define ir_3 A3 //пин 3 ИК-датчика
#define ir_4 A4 //пин 4 ИК-датчика
#define ir_5 A5 //пин 5 ИК-датчика
#define ir_6 A6 //пин 6 ИК-датчика
#define lev_vik 9 //пин левого выключателя
#define pra_vik 10 //пин правого выключателя
